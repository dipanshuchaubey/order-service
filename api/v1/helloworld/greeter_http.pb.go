...
const OperationGreeterHealthCheck = "/helloworld.v1.Greeter/HealthCheck"
...
func RegisterGreeterHTTPServer(s *http.Server, srv GreeterHTTPServer) {
	...
	r.GET("/health", _Greeter_HealthCheck0_HTTP_Handler(srv))
}
...
func _Greeter_HealthCheck0_HTTP_Handler(srv GreeterHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in HealthCheckRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationGreeterHealthCheck)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *GreeterHTTPClientImpl) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...http.CallOption) (*HealthCheckReply, error) {
	var out HealthCheckReply
	pattern := "/health"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationGreeterHealthCheck))
