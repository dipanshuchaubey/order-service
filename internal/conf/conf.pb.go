...
func (x *Bootstrap) GetPublisher() *Publisher {
	if x != nil {
		return x.Publisher
	}
	return nil
...
type Publisher struct {
	...
	OrderPublisher *Publisher_OrderPublisher `protobuf:"bytes,1,opt,name=order_publisher,json=orderPublisher,proto3" json:"order_publisher,omitempty"`
}
...
func (x *Publisher) GetOrderPublisher() *Publisher_OrderPublisher {
	if x != nil {
		return x.OrderPublisher
	}
	return nil
}
...
type Consumer struct {
	...
	OrderConsumer *Consumer_OrderConsumer `protobuf:"bytes,1,opt,name=order_consumer,json=orderConsumer,proto3" json:"order_consumer,omitempty"`
}
...
func (x *Consumer) GetOrderConsumer() *Consumer_OrderConsumer {
	if x != nil {
		return x.OrderConsumer
	}
	return nil
}
...
type Data_Database struct {
	...
	CredentialsPath string `protobuf:"bytes,3,opt,name=credentials_path,json=credentialsPath,proto3" json:"credentials_path,omitempty"`
}
...
func (x *Data_Database) GetCredentialsPath() string {
	if x != nil {
...
type Publisher_OrderPublisher struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Publisher_OrderPublisher) Reset() {
	*x = Publisher_OrderPublisher{}
	if protoimpl.UnsafeEnabled {
...
func (x *Publisher_OrderPublisher) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Publisher_OrderPublisher) ProtoMessage() {}

func (x *Publisher_OrderPublisher) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Publisher_OrderPublisher.ProtoReflect.Descriptor instead.
func (*Publisher_OrderPublisher) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Publisher_OrderPublisher) GetTopicArn() string {
	if x != nil {
		return x.TopicArn
	}
	return ""
...
func (x *Publisher_OrderPublisher) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
type Consumer_OrderConsumer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	RawMessage bool   `protobuf:"varint,4,opt,name=raw_message,json=rawMessage,proto3" json:"raw_message,omitempty"`
	WaitTime   int64  `protobuf:"varint,5,opt,name=wait_time,json=waitTime,proto3" json:"wait_time,omitempty"`
}

func (x *Consumer_OrderConsumer) Reset() {
	*x = Consumer_OrderConsumer{}
	if protoimpl.UnsafeEnabled {
...
func (x *Consumer_OrderConsumer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Consumer_OrderConsumer) ProtoMessage() {}

func (x *Consumer_OrderConsumer) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Consumer_OrderConsumer.ProtoReflect.Descriptor instead.
func (*Consumer_OrderConsumer) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{4, 0}
}

func (x *Consumer_OrderConsumer) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *Consumer_OrderConsumer) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *Consumer_OrderConsumer) GetQueueUrl() string {
	if x != nil {
		return x.QueueUrl
	}
	return ""
...
func (x *Consumer_OrderConsumer) GetRawMessage() bool {
	if x != nil {
		return x.RawMessage
	}
	return false
...
func (x *Consumer_OrderConsumer) GetWaitTime() int64 {
	if x != nil {
		return x.WaitTime
	}
	return 0
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x15, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x50, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	0x65, 0x72, 0x12, 0x30, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x73,
	0x75, 0x6d, 0x65, 0x72, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	0xa5, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61,
	...
	0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x52, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x1a, 0x65, 0x0a,
	...
	0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x72, 0x65,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73,
	0x50, 0x61, 0x74, 0x68, 0x1a, 0xd0, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18,
	...
	,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x71, 0x75,
	0x65, 0x75, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x61, 0x77, 0x5f, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x72, 0x61, 0x77,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x77, 0x61, 0x69, 0x74, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x77, 0x61, 0x69, 0x74,
	0x54, 0x69, 0x6d, 0x65, 0x42, 0x22, 0x5a, 0x20, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2d, 0x73, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Publisher)(nil),                // 3: kratos.api.Publisher
	(*Consumer)(nil),                 // 4: kratos.api.Consumer
	...
	(*Publisher_OrderPublisher)(nil), // 9: kratos.api.Publisher.OrderPublisher
	(*Consumer_OrderConsumer)(nil),   // 10: kratos.api.Consumer.OrderConsumer
	(*durationpb.Duration)(nil),      // 11: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	3,  // 2: kratos.api.Bootstrap.publisher:type_name -> kratos.api.Publisher
	4,  // 3: kratos.api.Bootstrap.consumer:type_name -> kratos.api.Consumer
	...
	9,  // 8: kratos.api.Publisher.order_publisher:type_name -> kratos.api.Publisher.OrderPublisher
	10, // 9: kratos.api.Consumer.order_consumer:type_name -> kratos.api.Consumer.OrderConsumer
...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Publisher_OrderPublisher); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_conf_conf_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Consumer_OrderConsumer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
